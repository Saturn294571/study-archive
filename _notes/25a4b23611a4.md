...
section: "계량기말"
math: true
source_path: "_notes/25a4b23611a4.md"
---
### 1. 고전적 모형
### 2. 일치성
###### 일치성(consistency)
...
1) Unbiasedness : Given n with repeated sampling
	- *첨부 이미지: Pasted image 20251202124843.png*
2) Consistency : n이 점점 커지는 상황 ($E(e|X)\neq0$ 라면, $n\to\infty$가 아니다)
	- *첨부 이미지: Pasted image 20251202124901.png*
###### 수요-공급의 내생성 예제
- ex) 수요-공급 곡선.    let 수요 : $Q_i=\alpha P_i+e_{Di}$ , 공급 : $Q_i=\alpha P_i+e_{Si}$
	- *첨부 이미지: Pasted image 20251202125520.png*
		- 그렇다면 $\hat{\alpha},\hat{\beta}$는 unbiased?
	- *첨부 이미지: Pasted image 20251202125551.png*
	...
	- 수요 충격이 발생했다 하자. ($e_{Di}\to e_{Di}'$)
		- *첨부 이미지: Pasted image 20251202130615.png*
